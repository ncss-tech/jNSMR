...
/*  22 */     doc = builder.build(new StringReader(file));
/*     */     
...
/* 139 */       smcsawc = Double.valueOf(whcOverride);
/*     */     } 
/*     */     
...
/* 151 */       maatmast = Double.valueOf(soilAirRelOverride);
/*     */     } 
/*     */     
/* 154 */     this
/*     */ 
/*     */       
/* 157 */       .dataset = new NewhallDataset(stationName, country, lat, lon, nsHemisphere, ewHemisphere, stationElevation, allPrecipsDbl, allAirTempsDbl, pdbegin, pdend, true, smcsawc.doubleValue());
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 163 */     NewhallDatasetMetadata ndm = new NewhallDatasetMetadata(stationName, stationId, stationElevation, stateProvidence, country, mlraName, mlraId, firstName, lastName, title, cntorg, address, city, stateprov, postal, cntCountry, cntemail, cntphone, allNotesStr, rundate, modelVers, srcunitsys, maatmast.doubleValue(), ampltd.doubleValue(), nettype);
/*     */     
/* 165 */     this.dataset.setMetadata(ndm);
/*     */     
/* 167 */     System.out.println("XML dataset built.");
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/andrew/workspace/jNSMR/inst/jNSM/jNSM_v1.6.1_public_bundle/libs/newhall-1.6.1.jar!/org/psu/newhall/util/XMLStringParser.class
